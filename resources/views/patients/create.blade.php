...
@section('content')
	<h3 class="title">Cadastro de paciente</h3>
	...
	<form action="/paciente/cadastrar" method="post">
		{!! csrf_field() !!}
		...
		<div class="form-group col-sm-4">
    		...
    		<input class="form-control" id="rg" type="text" name="rg" value="{{ old('rg') }}" required>
		</div>
		...
		<div class="form-group col-sm-4">
    		...
    		<input class="form-control" id="city" type="text" name="state" value="{{ old('city') }}">
		</div>
